...
class SearchObject(AbstractAction):
    CONTENT_SEPARATOR = "|"
    CONTENT_ASSOCIATION = ":"
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(Action.SEARCH_OBJECT, page)
        ...
        self.match = None if match is None else Match[match.upper()]
        self.sort_order = None if sort_order is None else SortOrder[sort_order.upper()]
        self.object_type = (
            None if object_type is None else ObjectType[object_type.upper()]
        )
        self.sort_criterion = (
            None if sort_criterion is None else SortCriterion[sort_criterion.upper()]
        )
