...
class Item:
    ...
    date_start: Optional[str] = field(
        default=None,
        metadata=dict(name="DATE_START", type="Element", namespace="", required=True),
    )
    date_end: Optional[str] = field(
        default=None,
        metadata=dict(name="DATE_END", type="Element", namespace="", required=True),
    )
    id: Optional[str] = field(
        default=None,
        metadata=dict(name="ID", type="Attribute", required=True, pattern=r"N\d+"),
    )
    ver: Optional[int] = field(
        default=None, metadata=dict(name="VER", type="Attribute", required=True)
    )
    type: str = field(
        init=False,
        default="convention",
    ...
    frq: Optional[int] = field(
        default=None, metadata=dict(name="FRQ", type="Attribute", required=True)
    )
    parent: Optional[str] = field(
        default=None, metadata=dict(name="PARENT", type="Attribute")
    )
